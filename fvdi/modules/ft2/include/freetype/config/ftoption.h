...
# define HB_VERSION_ATLEAST(x,y,z) 0
#endif
...
#define  TT_USE_BYTECODE_INTERPRETER
   ...
   */
/* needed for older versions, because it does not compile without */
/* if FREETYPE_VERSION < 2003000L */

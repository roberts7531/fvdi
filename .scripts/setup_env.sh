...
# we want to have $FT2_VERSION in the filename
if [ "${FT2_VERSION}" != "" ]; then PROJECT_VERSION="${PROJECT_VERSION}-ft${FT2_VERSION}"; fi
echo "PROJECT_VERSION=${PROJECT_VERSION}" >> $GITHUB_ENV
echo "FT2_VERSION=$FT2_VERSION" >> $GITHUB_ENV
